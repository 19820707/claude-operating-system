...
**Navigation:** see [INDEX.md](INDEX.md) for a full map of every file and when to use it. Quick paths: **[docs/QUICKSTART.md](docs/QUICKSTART.md)**, **[docs/VALIDATION.md](docs/VALIDATION.md)**, **[docs/AUTONOMY.md](docs/AUTONOMY.md)** (autonomy / `os-autopilot`), **[docs/VALUE-FOR-ENGINEERS.md](docs/VALUE-FOR-ENGINEERS.md)** (why / 17 concrete outcomes, PT), **[docs/RELEASE-READINESS.md](docs/RELEASE-READINESS.md)**, **[docs/SKILLS.md](docs/SKILLS.md)** (skills), **[playbooks/README.md](playbooks/README.md)** (playbooks), **[recipes/README.md](recipes/README.md)** (command recipes + `recipe-manifest.json`).
